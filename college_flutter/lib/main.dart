                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          SizedBox(height: 20),
                          _buildTextFormField(_greScoreController, 'GRE Score'),
                          SizedBox(height: 10),
                          _buildTextFormField(_toeflScoreController, 'TOEFL Score'),
                          SizedBox(height: 10),
                          _buildTextFormField(_universityRatingController, 'University Rating'),
                          SizedBox(height: 10),
                          _buildTextFormField(_essayRatingController, 'Essay Rating'),
                          SizedBox(height: 10),
                          _buildTextFormField(_recommendationRatingController, 'Recommendation Rating'),
                          SizedBox(height: 10),
                          _buildTextFormField(_cgpaController, 'CGPA'),
                          SizedBox(height: 10),
